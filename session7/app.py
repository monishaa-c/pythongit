...
@app.route("/index")   #index kudukalana kuda wrk aagum 

def hello():

    test = my_post[1]     #accessing an element from a list
    #test = my_post[1]["content"]    #accessing a value from a [{}], method 1 
    #test = my_post[2].get("content")    #accessing a value from a [{}], method 2 using get method 
