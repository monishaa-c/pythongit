# construct a table to display sunday to saturday

# from flask import Flask,render_template

# app = Flask(__name__)

# my_post = ["sunday","monday","tuesday","wednesday","thursday","friday","saturday"]
...
#task display mypost data in table format
